...
export const Adventure = [
    {
        ...
        list: [
            ...
            "Collaborated with global clients and cross-functional teams to define design requirements, ensuring alignment with business goals and user needs",
            "Conducted and led 10+ user research projects, including competitive analysis, user flows, interviews, and usability testing, to inform design decisions",
            "Created and maintained design systems, wireframes, prototypes, and high-fidelity UI designs that drove consistency and scalability",
            "Facilitated design workshops and feedback sessions with stakeholders, translating insights into actionable design improvements",
            "Championed accessibility, responsive design, and user-centered methodologies to elevate usability and inclusivity",
            "Contributed to successful app store launches by refining UI/UX and ensuring designs met both user expectations and technical feasibility",
        ],
    },
    {
        company: "WELF",
        ...
        list: [
            ...
            "Headed a dashboard project for image recognition–based retail execution and tracking services, improving operational efficiency for grocery retailers",
    ...
    },
    {
        ...
        list: [
            ...
            "Produced Hi-Fi user flows, site maps, personas, and research documents",
            "Created the new UI design and collaborated with the engineering team",
        ],
    },
];
export const Skills = [
